...
function  [S_TT]=GEN_ST_MS(Y0,P,Q,mu0,mu1,lag)

Y=Y0(lag+1:end,:); % 2 lags for the Kalman Filter
TSTAR=size(Y,1);
FLT_PR=zeros(TSTAR,2);
sig=1;  % variance of innovations of the factor
